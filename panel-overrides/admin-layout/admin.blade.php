...
<html>
    <head>
        ...
        <link rel="mask-icon" href="/assets/svgs/earthliving-logo.svg" color="#7d9b55">
        <link rel="shortcut icon" href="/assets/svgs/earthliving-logo.svg">
        ...
        @section('scripts')
            ...
            <link rel="stylesheet" href="/assets/earthliving-panel.css?v=20260517-blueprint">
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        <li class="admin-earthliving-note">
                            Earth Living control panel<br>
                        ...
                        <li class="{{ Route::currentRouteName() !== 'admin.plugins' ?: 'active' }}">
