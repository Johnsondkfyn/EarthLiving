...
- Velocity proxy test is online on `159.195.149.253:25567`, currently routing to the former test server as `hub`. Main server remains direct on `25565` until the final proxy port swap is intentionally performed.
