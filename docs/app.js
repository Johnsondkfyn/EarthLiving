...
const translations = {
  en: {
    ...
    "hero.work.item4": "EarthLiving Web Portal + EarthWebBridge",
    ...
    "plan.item4": "Start the secure player profile portal and EarthWebBridge account-linking layer.",
  ...
  da: {
    ...
    "plan.item4": "Start den sikre spillerportal og EarthWebBridge account-linking.",
