...
const translations = {
  en: {
    ...
    "portal.card2.item3": "Own report history and status",
    "portal.card2.item4": "Supporter/donation status later",
    "portal.card3.kicker": "Current state",
    "portal.card3.title": "Foundation build",
    "portal.card3.body": "EarthWebBridge now has the first server-side export plan. Public login and donations will be connected after the secure profile link flow is tested.",
  ...
  da: {
    ...
    "portal.card2.item3": "Egen report-historik og status",
    "portal.card2.item4": "Supporter/donation-status senere",
    "portal.card3.kicker": "Nuværende status",
    "portal.card3.title": "Foundation build",
    "portal.card3.body": "EarthWebBridge har nu første server-side export-plan. Public login og donationer kobles på efter det sikre profil-link flow er testet.",
    "community.eyebrow": "Community",
