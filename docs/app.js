...
const translations = {
  en: {
    ...
    "launch.body": "Main server, Discord bridge, report center, BlueMap foundation and EarthOS basics are being shaped before public access opens.",
    "signals.discord": "DiscordSRV live on main",
    ...
    "plan.body": "GitHub and Notion agree on the same direction: finish the core, keep gameplay GUI-first through EarthOS, then add living-world systems one layer at a time.",
    "plan.item1": "Keep the core as the backend for reports, events, Discord, EarthOS and future modules.",
    ...
    "plan.item4": "Start the region score engine that makes cities and systems feel connected.",
    ...
    "roadmap.note": "Current phase: foundation, website, EarthOS concept, report flow, branding and core planning. Progress is an early estimate and will change as systems move from planning into development.",
  ...
  da: {
    ...
    "launch.body": "Main server, Discord bridge, Report Center, BlueMap foundation og de første EarthOS-funktioner bliver bygget før offentlig adgang.",
    "signals.discord": "DiscordSRV live på main",
    ...
    "plan.body": "GitHub og Notion peger samme vej: færdiggør core, hold gameplay GUI-first gennem EarthOS, og byg living-world systemer lag for lag.",
    "plan.item1": "Hold core som backend for reports, events, Discord, EarthOS og fremtidige moduler.",
    ...
    "plan.item4": "Start region score-motoren, der får byer og systemer til at hænge sammen.",
    ...
    "roadmap.note": "Nuværende fase: foundation, website, EarthOS concept, report flow, branding og core planning. Fremskridt er et tidligt estimat og ændrer sig, når systemer går fra plan til udvikling.",
    "community.eyebrow": "Community",
