...
const translations = {
  en: {
    ...
    "devlog.item3.title": "Report Center workflow",
    "devlog.item3.body": "Panel actions can approve fixes, complete reports and reopen reports through the server plugin.",
  ...
  da: {
    ...
    "devlog.item3.title": "Report Center workflow",
    "devlog.item3.body": "Panel-actions kan godkende fixes, afslutte reports og genåbne reports gennem server-pluginet.",
