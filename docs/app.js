...
const translations = {
  en: {
    ...
    "hero.server.title": "Modern hub test world",
    ...
    "public.eyebrow": "Live foundation",
    "public.title": "Useful links for the private test phase.",
    "public.body": "The server is still invite-only, but the public site now shows the important access points clearly: community, live map, status and development updates.",
    "public.discord.kicker": "Community",
    "public.discord.title": "Discord invitation flow",
    "public.discord.body": "Discord is connected to the server. Public invites open when tester onboarding is ready.",
    "public.discord.button": "Follow community status",
    "public.map.kicker": "Live map",
    "public.map.title": "BlueMap foundation",
    "public.map.body": "The Earth map foundation is rendered and available while the permanent map domain is prepared.",
    "public.map.button": "Open live map",
    "public.status.kicker": "Server status",
    "public.status.title": "Hub test online",
    "public.status.phase": "Phase",
    "public.status.phaseValue": "Foundation",
    "public.status.core": "Core",
    "public.status.access": "Access",
    "public.status.accessValue": "Invite-only",
    "public.status.network": "Network",
    "public.status.networkValue": "Velocity hub test online",
    ...
    "media.earthos.title": "Profile and reports menu",
    "media.earthos.body": "EarthOS now connects reports, status and the first My EarthLiving profile-link flow.",
    "media.map.title": "Earth map preview",
    "media.map.body": "The live map is available during foundation work and will move to a cleaner map domain later.",
    "media.server.title": "Private test systems",
    "media.server.body": "Discord, Report Center, player stats exports and website status are now part of the foundation.",
    "devlog.eyebrow": "Devlog",
    "devlog.title": "Recent foundation updates.",
    "devlog.item1.title": "Player profile stats export",
    "devlog.item1.body": "EarthWebBridge now exports playtime, blocks broken, blocks placed, deaths, mob kills, distance and report summaries.",
    "devlog.item2.title": "My EarthLiving foundation",
    "devlog.item2.body": "EarthOS gained the first website profile link flow through one-time codes.",
    "devlog.item3.title": "Visible builder NPCs",
    "devlog.item3.body": "Admins can now position a blueprint ghost and hand the approved placement to a builder NPC, which constructs it block by block.",
    "technical.title": "Technical note",
    "technical.body": "Current hosting is Nginx on the EarthLiving server, not GitHub Pages. GitHub remains the source of truth for the website files.",
  ...
  da: {
    ...
    "hero.server.title": "Moderne hub-testverden",
    ...
    "public.eyebrow": "Live foundation",
    "public.title": "Nyttige links til privat testfasen.",
    "public.body": "Serveren er stadig invite-only, men hjemmesiden viser nu de vigtige adgangspunkter tydeligt: community, live map, status og udviklingsopdateringer.",
    "public.discord.kicker": "Community",
    "public.discord.title": "Discord invitation flow",
    "public.discord.body": "Discord er koblet på serveren. Offentlige invites åbner, når tester-onboarding er klar.",
    "public.discord.button": "Se community-status",
    "public.map.kicker": "Live map",
    "public.map.title": "BlueMap foundation",
    "public.map.body": "Earth map-fundamentet er renderet og tilgængeligt, mens det permanente map-domæne forberedes.",
    "public.map.button": "Åbn live map",
    "public.status.kicker": "Serverstatus",
    "public.status.title": "Hub-test online",
    "public.status.phase": "Fase",
    "public.status.phaseValue": "Foundation",
    "public.status.core": "Core",
    "public.status.access": "Adgang",
    "public.status.accessValue": "Invite-only",
    "public.status.network": "Netværk",
    "public.status.networkValue": "Velocity hub-test online",
    ...
    "media.earthos.title": "Profil og reports-menu",
    "media.earthos.body": "EarthOS forbinder nu reports, status og første My EarthLiving profile-link flow.",
    "media.map.title": "Earth map preview",
    "media.map.body": "Live map er tilgængeligt under foundation-arbejdet og flyttes senere til et renere map-domæne.",
    "media.server.title": "Private test-systemer",
    "media.server.body": "Discord, Report Center, player stats exports og website-status er nu en del af foundation.",
    "devlog.eyebrow": "Devlog",
    "devlog.title": "Seneste foundation-updates.",
    "devlog.item1.title": "Player profile stats export",
    "devlog.item1.body": "EarthWebBridge eksporterer nu spilletid, blocks ødelagt, blocks placeret, deaths, mob kills, distance og report summaries.",
    "devlog.item2.title": "My EarthLiving foundation",
    "devlog.item2.body": "EarthOS har fået første website profile-link flow gennem engangskoder.",
    "devlog.item3.title": "Synlige builder-NPC'er",
    "devlog.item3.body": "Admins kan nu placere et blueprint-preview og give den godkendte placering til en builder-NPC, som bygger blok for blok.",
    "technical.title": "Teknisk note",
    "technical.body": "Aktuel hosting er Nginx på EarthLiving-serveren, ikke GitHub Pages. GitHub er stadig source of truth for website-filerne.",
    "community.eyebrow": "Community",
